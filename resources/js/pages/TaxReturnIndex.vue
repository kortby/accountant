...
const getStatusColor = (status) => {
    switch (status) {
        ...
        case 'needs_action': return 'bg-red-100 text-red-700 border-red-200';
            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg border border-gray-200 p-6">
                    ...
                    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">Tax Filings</h3>
                            <p class="text-sm text-gray-500">Manage and track all your tax return submissions.</p>
                        </div>
                            ...
                            <TableBody>
                                ...
                                <TableRow v-for="tax in taxReturns.data" :key="tax.id">
                                    <TableCell class="font-medium">
                                        ...
                                        <div class="text-xs text-gray-500 font-normal">#{{ tax.id }}</div>
                                    </TableCell>
                                    <TableCell>
                                        <span 
                                    ...
                                    <TableCell>
                                        <div v-if="tax.status === 'completed'">
                                            <span v-if="tax.refund_amount > 0" class="text-green-600 font-medium">
                                                +{{ formatCurrency(tax.refund_amount) }}
                                            </span>
                                            <span v-else-if="tax.amount_due > 0" class="text-red-600 font-medium">
                                                -{{ formatCurrency(tax.amount_due) }}
                                            </span>
                                            <span v-else class="text-gray-500">-</span>
                                        </div>
                                        <div v-else class="text-gray-400 italic text-xs">Processing</div>
                                    </TableCell>
                                    <TableCell class="text-right">
                                        <Link :href="'/tax-returns/' + tax.id" class="text-orange-600 hover:text-orange-700 font-medium text-sm">
                                            View Details
                                        </Link>
                                    </TableCell>
                                </TableRow>
